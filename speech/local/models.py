...
def create_birnn_model(data_input, seq_length, model_settings, model_size_info, is_training):
    ...
    data_input = tf.reshape(data_input, [-1, num_inputs])

    with tf.name_scope('Layer_1'):
        W = variable_on_device('W1', [num_inputs, model_size_info[0]], tf.random_normal_initializer(
                stddev=w_stddev))
        b = variable_on_device('b1', [model_size_info[0]], tf.random_normal_initializer(
                stddev=b_stddev))
    ...
    with tf.name_scope('Layer_2'):
        W = variable_on_device('W2', [model_size_info[0], model_size_info[1]], tf.random_normal_initializer(
                stddev=w_stddev))
        b = variable_on_device('b2', [model_size_info[1]], tf.random_normal_initializer(
                stddev=b_stddev))
    ...
    with tf.name_scope('Layer_3'):
        W = variable_on_device('W3', [model_size_info[1], model_size_info[2]], tf.random_normal_initializer(
                stddev=w_stddev))
        b = variable_on_device('b3', [model_size_info[2]], tf.random_normal_initializer(
                stddev=b_stddev))
    ...
    with tf.name_scope('Layer_5'):
        W = variable_on_device('W5', [2 * model_size_info[3], model_size_info[4]], tf.random_normal_initializer(
                stddev=w_stddev))
        b = variable_on_device('b5', [model_size_info[4]], tf.random_normal_initializer(
                stddev=b_stddev))
    ...
    with tf.name_scope('Layer_6'):
        W = variable_on_device('W6', [model_size_info[4], num_character], tf.random_normal_initializer(
                stddev=w_stddev))
        b = variable_on_device('b6', [num_character], tf.random_normal_initializer(
                stddev=b_stddev))
